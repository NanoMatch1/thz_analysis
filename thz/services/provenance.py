...
# @record_provenance(store_return=False, note="baseline correction")
# def subtract_baseline(data: Acquisition, method: str = "poly", order: int = 2):
#     # do processing...
#     return data  # or modify in-place

# acq = Acquisition("S1")
# subtract_baseline(acq, method="poly", order=3)