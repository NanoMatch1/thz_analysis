"""Loaders for CSV and TXT style numeric files.
...
from thz.data_structures.spectrum import Spectrum
...
# Note: .txt loader is provided in thz/io/loaders/txt_loader.py in the project.
# We intentionally do not register a second TXT loader here to avoid duplicate
# registration with the loader registry. If needed, import and use the
# project's TXTLoader instead.
