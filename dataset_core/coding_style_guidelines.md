...
Use descriptive, explicit, and searchable names for variables, functions, classes, and files. Names should communicate purpose clearly and make the codebase easy to navigate through search.
