...
v_dsa = 0.25e-3; % Sample thickness. In this case will be air thickness between both subtrates
v_d = v_dsu*2;
...
% Refractive index
a_n0 = 1.0005.*a_nones;
a_n1s = m_refrac; % Refractive index to solve - substrate
a_n1r = 1.0005.*a_nones;
a_n2 = 1.0005.*a_nones;
a_n3s = m_refrac; % Refractive index to solve - substrate
a_n3r = 1.0005.*a_nones;
a_n4 = 1.0005.*a_nones;
...
% 	end
    ...
    m_refe = f_getcomplexfield(lv_n0,lv_n1r,lv_n2,lv_n3r,lv_n4,c_c,v_d0,v_d1,v_d2,v_d3,v_d4,a_freq(lv_k));
    m_meas = f_getcomplexfield(lv_n0,lv_n1s,lv_n2,lv_n3r,lv_n4,c_c,v_d0,v_d1,v_d2,v_d3,v_d4,a_freq(lv_k)); 
