...
v_d = 0.31e-3; % Sample thickness. In this case will be the sample thickness between both subtrates
...
%%
% Files
v_filenameRef = 'N2_ref - copia.dat'; % Insert file name for reference
v_filenameSam = 'Si_100K - copia.dat'; % Insert file name for sample
v_directory = strcat(pwd,'\Data_files\Marzo24\');
